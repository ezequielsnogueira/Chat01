...
@WebServlet("/ClienteServ9/ServletServidorLiga")
public class ServletServidor9 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public ServletServidor9() 
    {
        super();
    }
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
   	{
    	...
    	RequestDispatcher rd2 = request.getRequestDispatcher("msgRecebida.jsp");
